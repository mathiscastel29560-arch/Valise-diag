...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--interface", choices=["obd2", "kkl"], default=None, help="Surcharge l'interface (obd2/kkl)")
